...
#pragma region callbacks
    ...
    void App::set_window_resize_callback(window_resize_func callback)
    {
    ...
    void App::set_key_callback(key_callback_func callback)
    {
    ...
    void App::set_mouse_callback(mouse_callback_func callback)
    {
...
#pragma endregion
    ...
    void App::set_update_callback(update_func update)
    {
        m_update = update;
    }
